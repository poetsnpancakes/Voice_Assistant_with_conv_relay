...
<Response>
  <Connect>
    <ConversationRelay url="wss://{request.headers['host']}/stream" welcomeGreeting="You are talking to Grootbot!"></ConversationRelay>
  </Connect>
</Response>
    """
...
if __name__ == "__main__":
    ...
    uvicorn.run("relay_temp:app", port=port)
